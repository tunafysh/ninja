...
pub fn setup_logger() -> Result<(), fern::InitError> {
    let log_path = match std::env::consts::OS {
        "linux" => format!("{}{}",std::env::var("HOME").expect("Failed to get environment variable"), "/.local/share/com.tunafysh.ninja/logs/kurokage.log"),
        "macos" => format!("{}{}",std::env::var("HOME").expect("Failed to get environment variable"), "/Library/Application Support/com.tunafysh.ninja/logs/kurokage.log"),
        "windows" => format!("{}{}",std::env::var("LOCALAPPDATA").expect("Failed to get environment variable"), "\\com.tunafysh.ninja\\logs\\kurokage.log"),
        _ => "logs/kurokage.log".to_string(),
    };
