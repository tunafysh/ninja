...
export default function Page() {
  ...
  const { allShurikens, refreshShurikens, startShuriken, stopShuriken } =
    useShuriken();
  ...
  const baseTabIcons = [
    <HomeIcon
      key="home"
      className={`w-4 h-4 mr-1 ${activeIndex !== 0 ? "dark:text-[#ffffff99]" : "text-red-500"}`}
    />,
    <Cog
      key="cog"
      className={`w-4 h-4 mr-1 ${activeIndex !== 1 ? "dark:text-[#ffffff99]" : "text-orange-500"}`}
    />,
    <FileText
      key="file"
      className={`w-4 h-4 mr-1 ${activeIndex !== 2 ? "dark:text-[#ffffff99]" : "text-green-500"}`}
    />,
    <div className="relative">
      <Hammer
        key="wrench"
        className={`w-4 h-4 mr-1 -rotate-90 ${activeIndex !== 3 ? "dark:text-[#ffffff99]" : "text-indigo-500"}`}
      />
    </div>,
    <Database
      key="database"
      className={`w-4 h-4 mr-1 ${activeIndex !== 4 ? "dark:text-[#ffffff99]" : "text-purple-500"}`}
    />,
    <div key="zap" className="relative">
      ...
      <Sparkle
        className={`mr-1 h-4 w-4 ${activeIndex !== 5 ? "dark:text-[#ffffff99]" : ""}`}
        style={
          activeIndex === 5
            ? {
                fill: "none",
  ...
  const tabsIcons = devMode
    ? [
        ...
        <Code
          key="dev"
          className={`w-4 h-4 mr-1 ${activeIndex !== tabs.length - 1 ? "dark:text-[#ffffff99]" : "text-blue-500"}`}
        />,
      ]
    : baseTabIcons;
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden select-none rounded-t-xl">
      ...
      >
        ...
        <div
          className={`flex flex-row select-none items-center px-2 ${platform === "mac" ? "pt-2" : "pt-4"}`}
        >
          <Button
            variant={"ghost"}
            size={"icon"}
