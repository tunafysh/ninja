      ...
      <div className="p-3 md:p-4">
        ...
        {loading ? (
          gridView === "grid" ? (
            <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-3 md:gap-4">
              {[...Array(4)].map((_, i) => (
                <Card
                  key={`skeleton-${i}`}
                  className="bg-card border-border py-0"
                >
          ...
          gridView === "grid" ? (
            <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-3 md:gap-4">
              {allShurikens.map((service, index) => (
                <Card
                  key={service.metadata.name || `shuriken-${index}`}
                  className="bg-card border-border py-0"
                >
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem
                            onClick={async () => {
                              ...
                              if (name) {
                                await invoke("lockpick_shuriken", {
                                  shuriken: name,
                                });
                              }
                            }}
          ...
          <div className="text-center text-muted-foreground my-8">
            No Shurikens found. You can get shurikens at the{" "}
            <Button
